...
export class AddMissingEntities1766350297086 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "idx_sessions_cleanup" ON "user_sessions" ("is_active", "last_activity") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_dbc81ff542b1b3366bae195f2a" ON "user_sessions" ("expires_at") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_2c6e259a9af837c1a7090bdda1" ON "user_sessions" ("user_id", "is_active") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_e5eb7a3c7766f941fe16b9edec" ON "user_sessions" ("session_token") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_90d67965bc26f2663d1f38cd42" ON "verification_codes" ("code_type") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_389cd06509d9d78dae3758d46f" ON "verification_codes" ("expires_at", "is_verified") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_eece521909dea6cbe1c8238ee8" ON "verification_codes" ("user_id", "phone_number", "email") `,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ALTER COLUMN "phone_number" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ALTER COLUMN "phone_country_code" DROP NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_eece521909dea6cbe1c8238ee8"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_389cd06509d9d78dae3758d46f"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_90d67965bc26f2663d1f38cd42"`,
    );
    await queryRunner.query(`DROP TABLE "verification_codes"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_e5eb7a3c7766f941fe16b9edec"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_2c6e259a9af837c1a7090bdda1"`,
    );
    await queryRunner.query(
